...
const check_for_winner = () => {
    ...
    if (res[0] == player) {
        ...
        winner.innerText = "Niestety nie udało ci się";
        winner.classList.add("computerWin");
        win_line(res[1]);
        board_full = true
    } else if (board_full) {
        winner.innerText = "Remis! Kod rabatowy to 1234";
...
const reset_board = () => {
    play_board = ["", "", "", "", "", "", "", "", ""];
    board_full = false;
    winner.classList.remove("Wygrałeś");
    winner.classList.remove("Przegrana");
    winner.classList.remove("remis");
    winner.innerText = "";
    render_board();
};
